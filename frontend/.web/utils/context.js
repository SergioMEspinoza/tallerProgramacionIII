...
export const initialState = {"reflex___state____state": {"is_hydrated_rx_state_": false, "router_rx_state_": {"session": {"client_token": "", "client_ip": "", "session_id": ""}, "headers": {"host": "", "origin": "", "upgrade": "", "connection": "", "cookie": "", "pragma": "", "cache_control": "", "user_agent": "", "sec_websocket_version": "", "sec_websocket_key": "", "sec_websocket_extensions": "", "accept_encoding": "", "accept_language": "", "raw_headers": {}}, "page": {"host": "", "path": "", "raw_path": "", "full_path": "", "full_raw_path": "", "params": {}}, "url": "", "route_id": ""}}, "reflex___state____state.frontend___state____inventory_state": {"esta_autenticado_rx_state_": false, "lista_insumos_rx_state_": [{"id": 1, "nombre": "Filtro Dializador", "cantidad": 50, "vencimiento": "2026-05-20"}], "nueva_cantidad_rx_state_": "", "nueva_fecha_rx_state_": "", "nuevo_nombre_rx_state_": "", "password_input_rx_state_": "", "rol_usuario_rx_state_": "", "usuario_logueado_rx_state_": ""}, "reflex___state____state.reflex___state____frontend_event_exception_state": {}, "reflex___state____state.reflex___state____on_load_internal_state": {}, "reflex___state____state.reflex___state____update_vars_internal_state": {}}

export const defaultColorMode = "system"
export const ColorModeContext = createContext(null);
export const UploadFilesContext = createContext(null);
export const DispatchContext = createContext(null);
export const StateContexts = {reflex___state____state: createContext(null),reflex___state____state__frontend___state____inventory_state: createContext(null),reflex___state____state__reflex___state____frontend_event_exception_state: createContext(null),reflex___state____state__reflex___state____on_load_internal_state: createContext(null),reflex___state____state__reflex___state____update_vars_internal_state: createContext(null),};
...
const [reflex___state____state__frontend___state____inventory_state, dispatch_reflex___state____state__frontend___state____inventory_state] = useReducer(applyDelta, initialState["reflex___state____state.frontend___state____inventory_state"])
...
"reflex___state____state.frontend___state____inventory_state": dispatch_reflex___state____state__frontend___state____inventory_state,
...
createElement(StateContexts.reflex___state____state__frontend___state____inventory_state,{value: reflex___state____state__frontend___state____inventory_state},
